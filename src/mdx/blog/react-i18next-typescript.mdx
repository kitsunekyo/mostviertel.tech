...
date: "2022-09-20"
excerpt: "Prevent translation key typos and find missing translations at dev time."
tags: react, typescript
---

We use [https://react.i18next.com/](https://react.i18next.com/) to handle multi-language translations in our app.

Up until now we never knew how many actual issues we had with incorrect translation keys, or missing translations until I've added typesafety for our project. Let me tell you, I found plenty of hidden issues in our codebase. Isn't typescript just the best? 😉
